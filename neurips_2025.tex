...
Please read the instructions below carefully and follow them faithfully \cite{kalantidis2020hard}.

\subsection{Style}
% 推荐不用subsection这样占空间，可以直接黑体加粗说明小点

Papers to be submitted to NeurIPS 2025 must be prepared according to the
instructions presented here. Papers may only be up to {\bf nine} pages long,
including figures \cite{xuan2020hard}.
